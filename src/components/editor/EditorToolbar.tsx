...
import { ClassificationSettingsDialog } from './ClassificationSettings';
  ...
  return (
    <div className="sticky top-0 z-20 bg-background/80 backdrop-blur-sm border-b p-2">
      <div className="w-full max-w-[calc(21cm+4rem)] mx-auto">
        <div
          className="p-2 rounded-md border bg-card flex items-center justify-center gap-3 overflow-x-auto"
          style={{ direction: 'rtl' }}
        >
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  className="group p-2 rounded-lg hover:bg-white/10 transition-all"
                  title="Info"
                >
            ...
            <button
              className="group p-2 rounded-lg bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-400 hover:text-emerald-300 transition-all"
              title="Play"
            >
              <Play size={18} />
            </button>
            <button
              className="group p-2 rounded-lg bg-amber-500/10 hover:bg-amber-500/20 text-amber-400 hover:text-amber-300 transition-all"
              title="Pause"
            >
              <Pause size={18} />
            </button>
            ...
            <button
              className="group p-2 rounded-lg bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-400 hover:text-indigo-300 transition-all"
              title="Upload"
            >
              <Upload size={18} />
            </button>
            <button
              className="group p-2 rounded-lg bg-teal-500/10 hover:bg-teal-500/20 text-teal-400 hover:text-teal-300 transition-all"
              title="File"
            >
              <FileText size={18} />
            </button>

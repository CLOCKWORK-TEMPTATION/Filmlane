...
export const screenplayFormats: ScreenplayFormat[] = [
    ...
    { id: 'action', label: 'الفعل/الحدث', shortcut: 'Ctrl+4', color: 'bg-gray-200/50 dark:bg-gray-700/50', icon: Feather },
    { id: 'character', label: 'شخصية', shortcut: 'Ctrl+2', color: 'bg-green-200/50 dark:bg-green-800/50', icon: UserSquare },
    { id: 'parenthetical', label: 'بين قوسين', shortcut: 'Tab', color: 'bg-yellow-200/50 dark:bg-yellow-800/50', icon: Parentheses },
    { id: 'dialogue', label: 'حوار', shortcut: 'Ctrl+3', color: 'bg-orange-200/50 dark:bg-orange-800/50', icon: MessageCircle },
    { id: 'transition', label: 'انتقال', shortcut: 'Ctrl+6', color: 'bg-red-200/50 dark:bg-red-800/50', icon: FastForward }
];

export const formatClassMap: { [key: string]: string } = screenplayFormats.reduce((acc, format) => {
...
export const textSizes = [
    { value: '8pt', label: '8' }, { value: '9pt', label: '9' },
    { value: '10pt', label: '10' }, { value: '11pt', label: '11' },
    { value: '12pt', label: '12' }, { value: '14pt', label: '14' },
    { value: '16pt', label: '16' }, { value: '18pt', label: '18' },
    { value: '24pt', label: '24' }, { value: '36pt', label: '36' }
];
